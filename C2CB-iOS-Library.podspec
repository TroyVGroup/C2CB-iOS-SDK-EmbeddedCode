...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of C2CB-iOS-Library.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Satyam Kumar/C2CB-iOS-Library'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Satyam Kumar' => 'satyam.kumar@vgroup.net' }
  s.source           = { :git => 'https://github.com/Satyam Kumar/C2CB-iOS-Library.git', :tag => s.version.to_s }
