...
#import "TVOCallMessageDelegate.h"
...
/**
 *  @brief The `TVOLogger` used for logging.
 *
 *  @discussion If you wish to provide your own `TVOLogger` then you can set it by using this property.
...
/**
   ...
   ** An example of using the *handleNotification* API **
   ...
   @param delegate A `<TVONotificationDelegate>` to receive incoming push notification callbacks.
   @param delegateQueue The queue where the `[TVONotificationDelegate cancelledCallInviteReceived:error:]` method will invoked. By default the main dispatch queue will be used.
   @param callMessageDelegate The `<TVOCallMessageDelegate>` for `<TVOCallMessage>` related updates that are raised to the `TVOCallInvite`.
...
NS_SWIFT_NAME(handleNotification(payload:delegate:delegateQueue:callMessageDelegate:));
